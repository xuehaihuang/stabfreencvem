...
$\Vert\cdot\Vert_{m,K}$ and $|\cdot|_{m,K}$. By convention, let $L^2(K)=H^0(K)$. Denote by $L_0^2(K)$ the space of all functions in $L^2(K)$ with zero integral.
...
\XH{Recall (35) in \cite{Chen;Huang:2020Finite} that
